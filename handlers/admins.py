...
async def update_admin(client, message):
    ...
    await message.reply_text("✅ Bot **Reload hahahaha !**\n✅ **Admin list** telah di **updated !**")
...
async def pause(_, message: Message):
    ...
    if (chat_id not in callsmusic.pytgcalls.active_calls) or (
        ...
        await message.reply_text("❗ tidak ada streaming, hehe!")
    else:
...
async def resume(_, message: Message):
    ...
    if (chat_id not in callsmusic.pytgcalls.active_calls) or (
        ...
        await message.reply_text("❗ heh, gada yang di pause")
    else:
...
async def skip(_, message: Message):
    ...
    chat_id = get_chat_id(message.chat)
    if chat_id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("❗ tidak ada sttreaming, hehe!")
    else:
